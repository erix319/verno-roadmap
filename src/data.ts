...
export const ITEMS: Item[] = [
  ...
  },
  {
    ...
    meta: 'Фокеев · 66 из 123 уроков',
    note: 'Осталось 57 уроков: позиционирование и фильтры, табы, формы, настройки, ускорение, анимации, адаптив, SEO, экспорт. Раздел 13 «Интернет-магазин» можно пропустить — Webflow-магазины в РФ почти не заказывают.',
    hours: 12,
    video: 8.1,
    factor: 1.5,
