  ...
  return (
    <header className="hero">
      ...
      <p className="hero__lead">
        ...
        <strong>B — рост как программиста</strong> (fullstack-путь из чек-листов Google AI и DeepSeek). Ползунок ниже делит
        неделю между ними, галочки убирают шаги из расписания — и даты пересчитываются.
      </p>
